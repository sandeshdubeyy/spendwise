export const COLORS = {
	...
	navbarBg:
		"bg-white/80 backdrop-blur-md dark:bg-[#0b1f3a]/90",
	navbarBorder: "border-green-100 dark:border-blue-800/60",
	...
	// Interactive — green in light, blue in dark
	link: "text-slate-600 hover:text-green-700 dark:text-slate-300 dark:hover:text-blue-400",
	primaryBtn:
	...
	// Finance semantics (same both modes)
	...
	// Image placeholder boxes (hero mockups)
	mockupBorder:
